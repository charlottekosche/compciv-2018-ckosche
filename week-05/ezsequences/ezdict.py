...
def foo_c():
    ...
    """
    first_name = ez_dict ['name']['first']
    last_name = ez_dict ['name']['last']
    last_and_first_name = last_name + ", " + first_name
    return last_and_first_name
...
def foo_g():
    ...
    Hint: Think about how you can create a new list by
      ...
      method.
    """
    spouse_name = [ez_dict ['spouse']]
    children_names = ez_dict ['children'][0::]
    spouse_and_children = spouse_name + children_names
    return ",".join(spouse_and_children)
...
def foo_j():
    ...
    """
    full_URL = "http://docquery.fec.gov/cgi-bin/fecimg/?" + ez_dict ['identifiers']['fec']
    return full_URL
